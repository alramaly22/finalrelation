...
const EPILOGUE_SCRIPT = [
    ...
    { at: "0:18", text: "حاسس إن دي أهم صفحة في الموقع كله." },

    { at: "0:42", text: "لأنها... النهاية." },

    { at: "1:05", text: "الريكورد ده..." },

    { at: "1:22", text: "كان نفسي أبعته من زمان." },

    { at: "1:45", text: "بس اتبعت من كام يوم." },

    { at: "2:10", text: "وحسيت إن جه الوقت..." },

    { at: "2:30", text: "إني مبقاش شايل أي حاجة جوايا." },

    { at: "2:55", text: "لأن فعلاً..." },

    { at: "3:10", text: "أنا هبدأ صفحة جديدة." },

    { at: "3:40", text: "يا ملك..." },

    { at: "3:58", text: "أنا بحبك أوي بجد." },

    { at: "4:25", text: "وعمري ما هعمل أي غلطة تبعدك عني تاني." },

    { at: "4:55", text: "فضلت أدعي..." },

    { at: "5:15", text: "إننا نرجع ونفضل مع بعض." },

    { at: "5:45", text: "ودي أول مرة في حياتي أعمل كده علشان حد." },

    { at: "6:20", text: "أنا عمري ما نسيت أي ذكرى كانت بينا." },

    { at: "6:50", text: "ولا عمري نسيت كلامك." },

    { at: "7:20", text: "وبالنسبة ليا..." },

    { at: "7:35", text: "إنتي أجمل بنت شوفتها في حياتي." },

    { at: "8:10", text: "إنتي بيتي." },

    { at: "8:45", text: "ويمكن متفهميش معنى الكلمة..." },

    { at: "9:10", text: "بس أنا فعلًا بهرب لعندك." },

    { at: "9:45", text: "إنتي السبب..." },

    { at: "10:00", text: "إني أركز على مستقبلي." },

    { at: "10:20", text: "لأنك... مستقبلي." },

    { at: "10:40", text: "أنا بحبك أوي." },

    { at: "10:52", text: "وأوعدك..." },

    { at: "10:58", text: "هعمل كل حاجة علشان أستحقك." }
